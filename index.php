...
$stmt = $pdo->query("SELECT full_name, position, email FROM users WHERE role = 'staff'");
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body text-center">
                            <div class="mb-3">
                                <img src="assets/images/default-avatar.svg" alt="<?php echo htmlspecialchars($staff['full_name']); ?>" 
